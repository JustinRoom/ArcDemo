...
import jsc.exam.com.arc.fragments.ArcViewFragment;
import jsc.exam.com.arc.retrofit.ApiService;
...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ).showFirstTop(true).showLastBottom(true));
    ...
    private List<ClassItem> getClassItems() {
        ...
        classItems.add(new ClassItem(ClassItem.TYPE_FRAGMENT, "ArcDrawable", ArcDrawableFragment.class, true));
        classItems.add(new ClassItem(ClassItem.TYPE_FRAGMENT, "ArcView", ArcViewFragment.class, true));
